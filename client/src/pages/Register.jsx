  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0A0A0A] px-4 py-10">
      <div className="w-full max-w-md rounded-2xl border border-[#222222] bg-[#111111] p-8 shadow-2xl shadow-black/30">
        <div className="mb-6">
          <h1 className="font-['Sora',_sans-serif] text-2xl font-semibold tracking-tight text-white">Create your account</h1>
          <p className="mt-2 text-sm text-gray-500">Start organizing your internship applications.</p>
        </div>
